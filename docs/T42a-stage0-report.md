...
| 2026-07-30 16:35 | Phase 2 (1回目) | 2,397頭 | 2,393 | 0 | 6,000計 | 日次上限でクリーン停止 |
| 2026-07-31 05:25 | Phase 2 (2回目) | 8,396頭 (2026年分完了) | 5,997 | 3 | 6,000 | 日次上限でクリーン停止・2025年分へ |
| 2026-08-01 03:49 | Phase 2 (3回目) | **完走: 13,734/13,738頭 (99.97%)** | 5,340 | 4 | 5,345 | `stopped: null`=対象完遂。未取得4頭は全て「調教時計なしページ」の実データと診断確定 (0.03%・情報損失ゼロ) |
| 2026-08-01 04:10 | **完了監査** | — | 1 (診断) | — | — | **全量SHA-256監査: 33,229ファイル全件一致・欠損0・孤立0**。最終資産 = レース18,904 (99.99%) + 馬別13,734 (99.97%) + 日次インデックス589 + Stage 0馬3。**トライアル解約GO (8/1中・請求日8/2)**。以後の検証・特徴構築 (T42b) はキャッシュ上で退会後に実施 |
