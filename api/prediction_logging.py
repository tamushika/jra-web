...
def log_race_prediction(result: dict[str, Any], *, app_name: str, config: Any,
    ...
    for horse in result.get("horses", []):
        ...
        predictions.append({
            ...
            "ml_score": (horse.get("score") if horse.get("score_source") == "ml" else None)
                        if app_name == "win5" else horse.get("score_ml"),
            ...
            "score_details": {
                ...
                "score_source": horse.get("score_source"),
                "score_failure_reason": horse.get("score_failure_reason"),
            },
            "feature_snapshot": {
