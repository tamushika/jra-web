...
def main():
    ...
    _res, _nd, day_records = simulate_win5_compare(
        prob_races, upset_map, cov_cl, budgets=[50, 100, 150, 200, 300, 400, 500])
    report_skip_analysis(day_records, budgets=[100, 150, 200, 300, 400, 500])
    ...
    if args.lgbm:
        ...
        simulate_win5_compare(prob_races_gb, upset_map, cov_gb, budgets=[50, 100, 150, 200, 300, 400, 500])
